...
“Barang siapa yang beriman kepada Allah dan Hari Akhir maka hendaklah dia berkata baik atau diam” (HR. al-Bukhari dan Muslim).`, wm, 'DESACTIVAR ANTI-BADWORD', '.off antibadword', 'Lo siento', '.maaf', m)
        if (user.warning >= 10) {
            user.banned = true
            if (m.isGroup) {
                if (isBotAdmin) {
